...
try {
  const List = [
    ...
    // 企业微信获取订单列表
    {"id":"financeQueryOrder","url":"order/api/v1/deposit/queryAllOrder","format":false},
    // 获取订单详情
    {"id":"financeQueryOrderDetail","url":"order/api/v1/deposit/queryUserOrder","format":false},
    // 订单退款
    {"id":"cancelTrans","url":"order/api/v1/deposit/cancelTrans","format":false},
    // 服务总监查询预约列表
    {"id":"getAftersaleAllList","url":"OSB/api/v1/appointment/getAftersaleAllList","format":false},
    // 服务工程师查询预约服务列表
